...
const Footer = () => {
    return (
        <footer className="footer footer-center p-20 bg-[#5c5146] text-primary-content mx-auto ">
  <aside>
    ...
    <p className="font-bold">
      StudyTogether Industries Ltd. <br/>Providing reliable Study services since 1992
    </p> 
